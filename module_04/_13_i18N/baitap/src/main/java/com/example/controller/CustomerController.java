...
//    @GetMapping
//    public ModelAndView listCustomers(@RequestParam int pageable){
//        Page<Customer> customers = customerService.findAll(PageRequest.of(pageable,2));
...
//    }
    ...
    @GetMapping("/customers")
    public ModelAndView listCustomers(@RequestParam("search") Optional<String> search,@PageableDefault(size = 2) Pageable pageable){
